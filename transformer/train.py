...
def train_model(config):
    ...
    # Tensorboard
    writer = SummaryWriter(config["experiement_name"])
...
def greedy_decode(
    ...
    sos_idx = tokenizer_tgt.token_to_id("[SOS]")  # tokenizer tgt or src
    ...
    return decoder_input.squeeze(0)  # squeeze to remove the batch dimension
